...
export interface InternalQuery {
  // Minimal interface used by the shim. Real Query object not available.
...
export function useCollection<T = any>(memoizedTargetRefOrQuery: any | null | undefined): UseCollectionResult<T> {
  ...
  useEffect(() => {
    // Shim: no real Firestore available. Return empty results after a tick.
    ...
    const t = setTimeout(() => {
      // No data available in shim mode.
      setData(null);
      setIsLoading(false);
    }, 0);
